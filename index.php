...
<head>
    ...
    <title>PHP Projet08 Exercice02</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container-fluid col-11 p-3 m-4 border border-warning rounded justify-content-center">
        <div class="row ">
            <h1 class="col-12 text-secondary text-center">PHP Projet08 Exercice02</h1>
            <h2 class="col-12 text-info text-center">Afficher la date du jour au format année-mois-jour</h2>
        </div>
